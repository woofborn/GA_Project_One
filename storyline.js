var peasantQuest = [
    ...
    {//two
        message: `The cat scampers away and out the door.
    ...
    {//three
        message: `"Mrrow?" queries the cat, staring at you intently.
    ...
    {//four
        message: `As you call each name out, the cat distinctly ignores you and walks faster.
    ...
    {//five
        message: `While you are busy reciting famous sword names, you fail to notice someone approaching until a large shadow falls upon you.
    ...
    {//six
        message: `Intimidated by your knowledge of Sun Tzu's Art of War, the giant flees, dropping everything in his haste to get away.
        ...
        array: ["north-west", "north-east", "south-west", "south-east", "north-north-east", "south-south-west", "north-west-east", "south-north-west"]
    },

    {//seven
        message: `Recalling that compasses have yet to be invented, you resume looking at the map and notice a big circle around a crude drawing of a castle.
    ...
    {//nine
        message: `"Baaaaa humbug!" says the goat. "Your rhyming skillz are impressive. I will take you across the moat."
    ...
    {//10
        message: `You reach the other end of the moat and thank the goat.
